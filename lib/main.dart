...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => MyLoginPage(),
        '/home': (context) => MyHomePage(title: 'My home page'),
      },
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> fetchingTodos() async {
    var fetchedTodos = await todoService.fetchTodos();
    print('THis is todos $fetchedTodos');
    setState(() {
      todos = fetchedTodos;
    });
  }
  ...
  Future<void> _onChangeTodoStatus(int index) async {
  ...
  Future<void> _onDeleteTodo(int index) async {
...
class TodoList extends StatelessWidget {
  ...
  final void Function(int index) onChangeTodoStatus;
        ...
        child: Column(
          children: [
            signupOrLogin
                ? SignUpForm(
                    signUp: _signUp,
                    signUpUserNameInputController:
                        _signUpUserNameInputController,
                    signUpPasswordInputController:
                        _signUpPasswordInputController,
                  )
                : LoginForm(
                    login: _login,
            ...
            ElevatedButton(
              ...
              child: Text(
                signupOrLogin ? 'Go to sign in page' : 'Dont have an account?',
              ),
            ),
          ],
        ),
